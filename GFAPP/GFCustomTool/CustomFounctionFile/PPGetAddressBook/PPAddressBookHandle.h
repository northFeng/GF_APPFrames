...
@property(nonatomic,copy)NSString * sspassword;    // 上传通讯录需要用到支付密码
@property(nonatomic,copy)NSString * locaionstr;    // 地理位置的详细信息
@property(nonatomic,assign)NSString * isLocation;    // 位置是否授权了   0 YES 1 NO
@property(nonatomic,copy)NSString * isContacts;    // 通讯录是否授权。 0 YES 1 NO

@property(nonatomic,strong)NSMutableArray * addressbookArr;                 // 存储用户的信息
