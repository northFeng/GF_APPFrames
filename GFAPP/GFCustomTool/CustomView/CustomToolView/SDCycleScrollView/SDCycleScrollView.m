...
#pragma mark - 设置代理——注册自定义UICollectionViewCell
...
#pragma mark - 设置pageControl样式
///设置小圆点大小 ——> pageControl类型只有为TAPageControl类型时有些属性才能有效果
...
//设置小圆点图片属性 （只有pageControl为TAPageControl类型才有效）
