...
#pragma mark - 轮播图的代理 ——> 点击图片回调&&图片滚动回调
...
#pragma mark - 数据源API ——> 网络图片URL && 本地图片image && 轮播文字
//////////////////////  数据源API //////////////////////
...
#pragma mark - 滚动控制API ——>自动滚动间隔时间 && 是否自动滚动 && 图片滚动方向 && block监听点击 && block监听滚动
//////////////////////  滚动控制API //////////////////////
...
#pragma mark - 自定义样式API——>占位图 && 是否显示分页控件 && pagecontrol样式 && pagecontrol位置 && pagecontrol距离底部/右边的偏移量 &&pagecontrol大小、颜色、图片 && 轮播文字的样式 && 手动滑动手势控制
//////////////////////  自定义样式API  //////////////////////
...
/** 分页控件小圆标大小（样式为SDCycleScrollViewPageContolStyleAnimated才有效果） */
@property (nonatomic, assign) CGSize pageControlDotSize;

/** 分页控件小圆标间距(样式为SDCycleScrollViewPageContolStyleAnimated才有效果) */
